...
interaction~$U$~\citep{kuhner2000,greiner2002}.
The clean-system phase diagram and its experimental realisation in
optical lattices~\citep{jaksch2005} have been extensively
studied~\citep{greiner2002}.

In the presence of dissipation---modelled by local dephasing in the
Lindblad--Gorini--Kossakowski--Sudarshan (LGKS)
framework~\citep{lindblad1976,gorini1976,breuer2002}---the system is
...
on-site number states~\citep{pichler2010,poletti2012}.
...
experimental attention~\citep{diehl2008,verstraete2009,sieberer2016,daley2014}.
...
the state vector, using \texttt{scipy.sparse.linalg.expm\_multiply}~\citep{scipy2020},
...
matrix-product-operator Lindblad evolution~\citep{daley2014}.

\begin{acknowledgments}
The author thanks the open-source scientific Python community for the
libraries underlying this work: NumPy, SciPy~\citep{scipy2020}, pandas,
matplotlib, and tqdm.
\end{acknowledgments}
