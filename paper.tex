...
Here ``handle'' denotes an operational intervention comparison under fixed
Lindblad dynamics---selectively changing local dephasing rates and
measuring the response---not statistical causal identification from
observational data.
...
95\% CI exceeds zero.
Bootstrap CIs quantify uncertainty over random-control draws and are used
descriptively.
...
identify intervention-sensitive sites; the 95\% CIs are strictly negative at
