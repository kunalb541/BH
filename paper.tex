...
which, by the reflection symmetry of the model, coincide with the
geometrically central sites --- are tested as causal handles:
...
$\tau\in\{2,3\}$ at $L=8$, and passes only at $\tau=3$ at $L=9$.
...
A further structural limitation of the present design is that, due to the
reflection symmetry established above, the high-$\Fi$ selector and a
geometric central-$k$ selector are identical in this model.
The experiment therefore establishes that targeting the $k$ central sites
produces more occupation loss than matched-budget random targeting in the
positive pocket; it cannot presently attribute the effect to the variance
information specifically rather than to the spatial position.
Disentangling the two requires breaking the spatial symmetry --- through,
for example, disorder, asymmetric filling, or site-dependent coupling ---
